          ...
          >
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className="flex-1 px-4 py-3 sm:py-4 bg-foreground text-background rounded-lg text-[10px] sm:text-[11px] font-bold uppercase tracking-wider hover:opacity-90 transition-all"
              >
                Añadir al Carrito
              </button>
            </div>
